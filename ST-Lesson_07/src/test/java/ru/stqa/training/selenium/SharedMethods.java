...
// ---------------------------------------------------------------------------------------------------------	
	private static List<WebElement> getElements(final WebDriver driver, final By locator) {
		return driver.findElements(locator);
	}
	
	private static List<WebElement> getElements(final WebElement element, final By locator) {
...
// ---------------------------------------------------------------------------------------------------------	
	public static String getText(final WebDriver driver, By locator) {
		return getElement(driver, locator).getText();
	}
	
	public static String getText(final WebElement element, By locator) {
