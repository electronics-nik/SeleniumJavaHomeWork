...
public enum ProductPageMap {
	HEADER_PAGE_ADD("Add New Product", "td#content > h1", TypeLocator.CSS),
	HEADER_PAGE_EDIT("Edit Product:", "td#content > h1", TypeLocator.CSS),
	...
	GENERAL_CATEGORY_NAME("", "//*[@id='tab-general']//input[contains(@name,'categories')]/../../td[count(input)=0]", 
		TypeLocator.XPATH),
	...
	GENERAL_GENDER_NAME("", "//*[@id='tab-general']//input[contains(@name,'product_groups')]/../../td[count(input)=0]", 
		TypeLocator.XPATH),
