...
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_CATEGORY_CHECK_BOX;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_CATEGORY_NAME;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_CODE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_DATE_VALID_FROM;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_DATE_VALID_TO;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_DEFAULT_CATEGORY;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_DEF_CATEGORY_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_DELIVERY_STATUS;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_DELIVERY_STATUS_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_GENDER_CHECK_BOX;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_GENDER_NAME;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_NAME;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_QUANTITY;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_QUANTITY_UNIT;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_QUANTITY_UNIT_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_SOLD_OUT_STATUS;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_SOLD_OUT_STATUS_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_STATUS_DISABLE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_STATUS_ENABLE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.GENERAL_UPLOAD_IMAGES;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.HEADER_PAGE_ADD;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_DESCRIPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_HEAD_TITLE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_KEYWORDS;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_MANUFACTURER;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_MANUFACTURER_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_META_DESCRIPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_SHORT_DESCRIPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_SUPPLIER;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.INFORMATION_SUPPLIER_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_CURRENCY_OF_PURCHASE_PRICE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_CURRENCY_OF_PURCHASE_PRICE_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_PRICE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_PRICE_CURRENCY_NAME;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_PRICE_INCLUDE_TAX;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_PURCHASE_PRICE_VALUE;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_TAX_CLASS;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.PRICE_TAX_CLASS_OPTION;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.SAVE_BTN;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.CANCEL_BTN;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.TAB_LIST;
import static ru.stqa.training.page.object.admin.product.ProductPageMap.TAB_URL;
...
public class ProductPageObject extends PageObject {
	...
	public boolean pageIsPresent() {
		return waitElementPresent(driver, HEADER_PAGE_ADD.by(), wait);
	}
