...
import ru.stqa.training.page.object.user.cart.CartPageObject;
import ru.stqa.training.page.object.user.header.HeaderPageObject;
import ru.stqa.training.page.object.user.home.HomePageObject;
import ru.stqa.training.page.object.user.product.ProductPageObject;
...
public class LiteCartTest extends TestBase{
	...
	@Test(priority = 10, dependsOnMethods = "addPtoductToCart")
